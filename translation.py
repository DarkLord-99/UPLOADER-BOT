...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Thanks for using Url Uploader X Bot\n\n<b>Join Updates channel contact: @hellodarklord</b>"
...
If bot didn't respond, contact @hellodarklord"""
